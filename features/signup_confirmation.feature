Feature: Sign Up confirmation
  ...
  Scenario: Confirm account with valid key
    Given there is an unconfirmed user with sha1_salt "1234567890123456789012345678901234567890" and email "default@sub.domain"
    When I confirm the key generated by sha1_salt "1234567890123456789012345678901234567890" and email "default@sub.domain"
